...
<script src="{{ asset('bower_components/jquery-alertable-master/jquery.alertable.min.js') }}">
</script>
<!-- DataTables -->
...
<!-- jQuery Knob Chart -->
<script src="{{ asset('bower_components/jquery-knob/dist/jquery.knob.min.js') }}">
</script>
<!-- daterangepicker -->
...
<script src="{{ asset('plugins/datepicker/datepicker.min.js') }}">
</script>
<!-- bootstrap time picker -->
<script src="{{ asset('plugins/timepicker/bootstrap-timepicker.min.js') }}">
</script>
...
<!-- Select2 -->
<script src="{{ asset('bower_components/select2/dist/js/select2.full.min.js') }}">
</script>
<!-- Morris.js charts -->
...
{{--
<script src="{{ asset('bower_components/chart.js/Chart.js') }}">
</script>
--}}
